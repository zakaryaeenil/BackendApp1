...
namespace NejPortalBackend.Application.Comptes.Commands.ChangePasswordCompte;
...
public class ChangePasswordCompteCommandValidator : AbstractValidator<ChangePasswordCompteCommand>
{
    public ChangePasswordCompteCommandValidator()
    {
        ...
        RuleFor(x => x.ConfirmPassword).NotNull().NotEmpty().WithMessage("ConfirmPasswordis required.");
    }
}
